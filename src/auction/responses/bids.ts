...
export class BidsWitdrawByOwnerDto implements BidsWithdraw {
  @ApiProperty({ name: 'leader', items: { type: 'BidsWitdrawByOwner', default: '' }, required: false, type: 'array', isArray: true })
  leader: Array<BidsWitdrawByOwnerItemDto>;

  @ApiProperty({ name: 'withdraw', items: { type: 'BidsWitdrawByOwner', default: '' }, required: false, type: 'array', isArray: true })
