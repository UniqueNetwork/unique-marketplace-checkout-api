...
export class CreateView_SearchIndex_2022072000000000 implements MigrationInterface {
  name = 'CreateView_SearchIndex_2022072000000000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP VIEW IF EXISTS "v_offers_search" CASCADE`);

    await queryRunner.query(`CREATE OR REPLACE VIEW "v_offers_search" AS  SELECT DISTINCT offer.id AS offer_id,
